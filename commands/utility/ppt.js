    ...
    async execute(interaction) {
        try {
            ...
            await targetUserInteraction.reply({
                content: `Você escolheu ${targetUserChoice.nome + targetUserChoice.emoji
                    }`,
                flags: MessageFlags.Ephemeral,
            });
            ...
            embed.setDescription(
                `${adversario} escolheu ${targetUserChoice.nome + targetUserChoice.emoji
                }\n
        ${interaction.user} escolheu ${initialUserChoice.nome + initialUserChoice.emoji
                }\n
        \n
        ${result}`
            );
